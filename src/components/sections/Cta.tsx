...
import { ArrowRight, Calendar, Shield, MapPin, Star } from 'lucide-react';
...
export default function CTA() {
  const stats = [
    ...
    { value: '500+', label: 'Happy Guests', icon: Calendar },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Book directly with City Stay Apartments and save on platform fees while enjoying
                personalized service and premium accommodations in prime locations.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Protected transactions and flexible cancellation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Downtown and residential areas with easy access
              </p>
            </div>
          </div>
        </div>
